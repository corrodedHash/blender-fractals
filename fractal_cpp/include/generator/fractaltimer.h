...
class FractalTimer {
  ...
  void print()
  {
    ...
    std::cout << "Commands: "
              << rot_diff + move_diff + draw_diff + face_diff + endf_diff + push_diff + pop_diff
              << std::endl;
    std::cout << "Iterate: " << it_diff << "\n";
    std::cout << "Copy: " << cp_diff << "\n";
    std::cout << "All: " << all_diff << "\n";
    std::cout << "Total: "
              << rot_diff + move_diff + draw_diff + face_diff + endf_diff + push_diff + pop_diff + it_diff + cp_diff
              << std::endl;
  }
};
}
