...
# Fetching the tool
add_custom_command(OUTPUT ${ANTLR4CPP_TOOL_LOCATION} COMMAND curl --output ${ANTLR4CPP_TOOL_LOCATION} ${ANTLR4CPP_TOOL_URL})
...
ExternalProject_ADD(
  ...
  #--Configure step-------------
  CONFIGURE_COMMAND  ${CMAKE_COMMAND} -DCMAKE_CXX_FLAGS=-fPIC -DCMAKE_BUILD_TYPE=${DCMAKE_BUILD_TYPE} -DANTLR4CPP_JAR_LOCATION=${ANTLR4CPP_TOOL_LOCATION} -DBUILD_SHARED_LIBS=ON -BUILD_TESTS=OFF -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DCMAKE_SOURCE_DIR:PATH=<SOURCE_DIR>/runtime/Cpp <SOURCE_DIR>/runtime/Cpp
  LOG_CONFIGURE ON
  #--Build step-----------------
  BUILD_COMMAND $(MAKE)
  LOG_BUILD ON
